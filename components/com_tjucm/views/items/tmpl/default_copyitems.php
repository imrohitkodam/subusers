		...
		<div class="modal-body">
			<div class="container-fluid">
				<div class="control-group span6 ucmListField">
					...
					<?php echo HTMLHelper::_('select.genericlist', '', 'filter[target_ucm]', 'class="target_ucm" onchange=""', 'text', 'value', $this->state->get('filter.target_ucm'), 'target_ucm' ); ?>
				</div>
				<div class="control-group span6 clusterListField">
					...
					<?php echo HTMLHelper::_('select.genericlist', '', 'filter[cluster_list]', 'class="cluster_list" onchange="" multiple', 'text', 'value', $this->state->get('filter.cluster_list'), 'cluster_list' ); ?>
				</div>
			</div>
		</div>
