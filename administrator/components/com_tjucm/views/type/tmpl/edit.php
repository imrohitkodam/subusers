...
<script >
	jQuery(document).ready(function(){
		...
		var selectElement = document.getElementById("jform_params_layout");

		// Iterate through the options within the "From shaper_helix3 Template" optgroup
		var options = selectElement.querySelectorAll('optgroup[label="---From shaper_helix3 Template---"] option');
		options.forEach(function(option) {
		    if (option.value === "shaper_helix3:singlecolumnlayout") {
		        option.textContent = "Single Column Layout";
		        jQuery("#jform_params_layout").trigger("chosen:updated");
