...
class TjucmControllerItemForm extends FormController
{
	...
	public function edit($key = null, $urlVar = null)
	{
		...
		// DPE Hack Changes for URL - $this->setRedirect(Route::_('index.php?option=com_tjucm&view=itemform' . $recordId . '&Itemid=' . $itemId, false));
		$this->setRedirect(Route::_('index.php?option=com_tjucm&view=itemform' . $recordId . $cluster . '&Itemid=' . $itemId, false));
	}
	...
	{
		// DPE hack
		// Set Null values in Session after cancel the changes
