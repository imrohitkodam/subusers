...
*/
		...
		if (!empty($clusters))
		{
			...
			{
				// DPE hack for Get Cluster List by ACL
				if (RBACL::check($user->id, 'com_cluster', 'core.manage.lessons', 'com_tjlms', $clusterList->id) || $user->authorise('core.manageall', 'com_cluster'))
				{
